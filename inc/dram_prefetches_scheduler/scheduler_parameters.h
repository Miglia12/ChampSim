...
inline constexpr bool perfect_speculative_opening = true;     // Enables perfect speculative opening mode
...
inline constexpr bool ENFORCE_BANK_IDLE_CONSTRAINT = false; // When true, only marks scheduler hits as useful when target bank is idle
